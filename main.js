function getProbabilityAge(age) {  // call only when they are NOT diagnosed
  ...
  if (20 <= age && age < 30) {
    ...
    answer.push("* Breast Cancer Mortality rate upon incidence is less than 1.0% | 1 in 100");
  }
  return answer;
}
...
function getRecommendations(age, p_status, highrisk) {
  ...
  console.log("Given your age, following are the recommendations to support you in preventing Breast Cancer :");
  if (age >= 20 && age < 30)
  {
  ...
  console.log("\nFollowing these recommendations will get you a step ahead in better reducing your chances of being diagnosed with breast cancer while also taking care of your physical and mental health.\n\n\n");
  return;
}
...
function getProbforeth(ethnicity) {
  ...
  if (ethnicity.toLowerCase().includes("White".toLowerCase())) {
    ...
    answer.push("* Breast Cancer Incidence is 0.093%");
    ...
    answer.push("* Breast Cancer Incidence is 0.094%");
    answer.push("* Breast Cancer Mortality upon incidence is 0.014%");
  }
  return answer;
}
...
function main(age, ethnicity, diagnosed, highrisk, p_status) {
  if (diagnosed.toLowerCase().includes("N".toLowerCase())) {
    ...
    console.log('\n')
    console.log('Given your age, the probability for :');
    printProbability(getProbabilityAge(age));
    console.log('Given your ethnicity, the probability for :');
    printProbability(getProbforeth(ethnicity));
    getRecommendations(age, p_status, highrisk);
  } else {  // when the patinet is
    console.log('\n')
